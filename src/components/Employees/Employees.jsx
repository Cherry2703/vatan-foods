  ...
  return (
    <div className="employees-page">
      ...
      {loading ? (
        ...
        <p className="loading">No employees found.</p>
      ) : (
        <div className="employees-grid">
          {employees.map((emp) => (
            <div
      ...
      {selected && (
        <div className="modal-overlay" onClick={() => setSelected(null)}>
          ...
          >
            ...
            <div className="modal-info">
              <p><strong>Email:</strong> {selected.email}</p>
              <p><strong>Phone:</strong> {selected.mobile || "-"}</p>
              <p><strong>Department:</strong> {selected.department || "-"}</p>
              <p><strong>Designation:</strong> {selected.designation || "-"}</p>
              <p><strong>Gender:</strong> {selected.gender || "-"}</p>
              <p><strong>DOB:</strong> {selected.DOB ? new Date(selected.DOB).toDateString() : "-"}</p>
              <p><strong>Joined:</strong> {selected.createdAt ? new Date(selected.createdAt).toDateString() : "-"}</p>
            </div>
          </div>
        </div>
      )}
